...
- [x] Explain what a token is used for.
    ***** ANSWER *****  
      Tokens are created when a user logs in. This token allows the user to access protected pages as long as the token is "valid". Once the token expires, the user will have to log in again before being able to visit the same pages. This token gives us more security on the internet without sacrificing user experience.

- [ ] What steps can you take in your web apps to keep your data secure?
    ***** ANSWER ***** 
      We can set up authentication systems, develop password reset systems, filter inputs from our users, and protect sensitive data with things like firewalls

- [ ] Describe how web servers work.
    ***** ANSWER ***** 
    When we need a specific file to display on our web pages, we request them from web clients through HTTP. We communicate during this process with various errors like 404 "not found" in order to get what we need or adjust our request.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
    ***** ANSWER ***** 
    CRUD stands for create/read/update/delete. Create = POST requests, Read = GET requests, Update = PUT requests, Delete = DELETE requests
